...
\begin{frame}
    ...
    \begin{itemize}
        \item\link{https://www.facebook.com/groups/787046402121728/}{Facebook Groep}
        \item\link{http://tuyaux.winak.be/}{Tuyaux}
        \item Lidkaart
        \item Mentoren
        \begin{itemize}
           	\item\link{https://www.facebook.com/louis.vangaelen} {Louis (Wiskunde)}
           	\item\link{https://www.facebook.com/Yngvard.zappacostas} {Ingvar (Fysica)}
			\item\link{https://www.facebook.com/sam.pieters.77} {Sam (Informatica)}
		\end{itemize}
		\item Activiteiten
...
\begin{frame}
	...
	\only<1>{\includegraphics[width=\linewidth]{res/sisa_rooster_1}}
	\only<2>{\includegraphics[width=\linewidth]{res/sisa_rooster_2}}
	\visible<3>{\includegraphics[width=\linewidth]{res/sisa_rooster_3}}
