...
\begin{frame}%
    ...
    \begin{minipage}{0.30\linewidth}%
        ...
        \footnotesize Arno Deceuninck -2Ba\strut%
    \end{minipage}
    \begin{minipage}{0.30\linewidth}%
        \centering%
    ...
    \begin{minipage}{0.30\linewidth}%
        ...
        \footnotesize Mateo Sierens -2Ba\strut%
    \end{minipage}
      	
    \begin{minipage}{0.30\linewidth}%
        \centering%
		\includegraphics[width=\linewidth]{res/stijn} \\%
        \footnotesize Stijn Rosaer -3Ba\strut%
    \end{minipage}
    \begin{minipage}{0.30\linewidth}%
        \centering%
		\includegraphics[width=\linewidth]{res/senne} \\%
        \footnotesize Senne Rosaer -3Ba\strut%
    \end{minipage}
    \begin{minipage}{0.30\linewidth}%
		\centering%
		\includegraphics[width=\linewidth]{res/toon} \\%
		\footnotesize Toon Meynen -3Ba\strut%
    \end{minipage}
\end{frame}  
