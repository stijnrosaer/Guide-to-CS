...
\begin{frame}%
    ...
    \begin{minipage}{0.30\linewidth}%
        \centering%
        \noindent\includegraphics[width=\linewidth]{res/andrei} \\%
        \footnotesize Andrei Bondarenko \strut%
    \end{minipage}
    \begin{minipage}{0.30\linewidth}%
        \centering%
    ...
    \begin{minipage}{0.30\linewidth}%
        ...
        \footnotesize Igor Schittekat \strut%
    \end{minipage}
      	
    \begin{minipage}{0.30\linewidth}%
        \centering%
		\includegraphics[width=\linewidth]{res/joey} \\%
        \footnotesize Joey De Pauw \strut%
    \end{minipage}
    \begin{minipage}{0.30\linewidth}%
        \centering%
